...
ALLOWED_HOSTS = ['nevis.dhcp.snl.salk.edu', 'localhost','localhost:8000']
...
EMAIL_HOST = "smtp.snl.salk.edu"
MANAGERS = ADMINS

DEFAULT_FROM_EMAIL = 'web-admins@snl.salk.edu'
#Against the docs, this gets used as the from address. 
#The docs say DEFAULT_FROM_EMAIL
...
SECRET_KEY = 'qj@i0z4l=6h+1+p-^r)w=oqy6j6*ut_cl6&amp;zn1id1f5l+($&amp;h4'
